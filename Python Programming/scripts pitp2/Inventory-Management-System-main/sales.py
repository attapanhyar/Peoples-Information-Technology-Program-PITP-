...
class salesClass:
    def __init__(self,root):
        ...
        self.root.title("AL-Shifa Hospital | by Ali")
        ...
        #------------- image -----------------
        self.bill_photo=Image.open("D:\quest\PITP\Python Programming\scripts pitp2\Inventory-Management-System-main\images\cat2.jpg")
