...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("CTkScrollableFrame PITP")
        ...
        for i in range(20):  # add items with images
            self.scrollable_label_button_frame.add_item(f"image and item {i}", image=customtkinter.CTkImage(Image.open(os.path.join(current_dir,  "QuestLogo.png"))))
